Files in this directory for Project 6:
...
The following files are not needed until Project 7:
- proj7.vtk: The file to use to make your screenshot for project turnin.
...
- proj7.cxx: you will create this from your proj6A.cxx and extend it to 3D.
